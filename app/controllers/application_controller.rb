class ApplicationController < ActionController::Base
	...
	before_action :authenticate_request, unless: -> { public_route? }
	...
	def public_route?
    	request.path == 'admin' ||'/admin/login' || request.path == '/admin/forgot_password' # Add more public routes as needed
    end
end
